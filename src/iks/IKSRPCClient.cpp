...
namespace logicalaccess
{
    namespace iks
    {
        ...
        ByteVector IKSRPCClient::aes_encrypt(const ByteVector &in, const std::string &key_name, const ByteVector &iv) {
            grpc::ClientContext context;
        ...
        ByteVector IKSRPCClient::aes_decrypt(const ByteVector &in, const std::string &key_name, const ByteVector &iv) {
            grpc::ClientContext context;
            CMSG_AESOperation req;
            req.set_key_name(key_name);
            req.set_payload(std::string(in.begin(), in.end()));
